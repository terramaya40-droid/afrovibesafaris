    ...
    <div className="wellness-page">
      <section className="wellness-hero" style={{ backgroundImage: `url(${getImageUrl('afrovibesafaris/wellness/hero')})` }}>
        ...
        <div className="container wellness-hero-content text-center">
          ...
          <p className="max-w-2xl mx-auto">
            Experience the healing power of the African wilderness. 
            Designed for relaxation and reconnection, combining wildlife experiences with calm, mindful moments in nature.
          </p>
      ...
      <section className="wellness-intro container py-xl text-center">
        ...
        <p className="max-w-2xl mx-auto text-gray-500">
          Our wellness safaris go beyond traditional game viewing. We create space for reflection, 
          silence, and deep connection with the vast African landscape.
        </p>
      </section>
